 ...
 * at ±0.50/0.58 on X/Z, board surface at Y = 0.02).
 */
const RESERVE_POSITIONS: [number, number, number][][] = [
  [[-0.58, 0.02, -0.58], [-0.50, 0.02, -0.58], [-0.50, 0.02, -0.50], [-0.58, 0.02, -0.50]],
  [[ 0.58, 0.02, -0.50], [ 0.50, 0.02, -0.50], [ 0.50, 0.02, -0.58], [ 0.58, 0.02, -0.58]],
  [[ 0.58, 0.02,  0.58], [ 0.50, 0.02,  0.58], [ 0.50, 0.02,  0.50], [ 0.58, 0.02,  0.50]],
  [[-0.58, 0.02,  0.50], [-0.50, 0.02,  0.50], [-0.50, 0.02,  0.58], [-0.58, 0.02,  0.58]],
];
